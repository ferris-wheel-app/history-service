...
import com.ferris.history.contract.resource.Resources.Out.DeletionResult
import com.ferris.history.contract.sample.{SampleData => SD}
...
class HistoryServiceClientTest extends FunSpec with Matchers with ScalaFutures with MockitoSugar with HistoryRestFormats {

  implicit val system = ActorSystem()
  implicit val mat = ActorMaterializer()

  val mockServer: HistoryServer = mock[HistoryServer]
  val client = new HistoryServiceClient(mockServer)
  ...
  describe("a history service client") {
